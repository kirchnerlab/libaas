...
void Stoichiometry::set(const libaas::elements::Element& element, const Double& count)
{
    if (count == 0.0) {
...
void Stoichiometry::add(const libaas::elements::Element& element, const Double& count) {
