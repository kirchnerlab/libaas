...
struct AminoAcidTestSuite: vigra::test_suite {
    ...
    void testAminoAcid()
    {
        ...
        shouldEqual(AminoAcidImpl(AminoAcidImpl::PEPTIDE_C_TERM).isCTerm(), true);
        shouldEqual(AminoAcidImpl(AminoAcidImpl::PROTEIN_C_TERM).isCTerm(), true);
        shouldEqual(AminoAcidImpl(AminoAcidImpl::PEPTIDE_N_TERM).isNTerm(), true);
        shouldEqual(AminoAcidImpl(AminoAcidImpl::PROTEIN_N_TERM).isNTerm(), true);
    ...
    void testAddAminoAcid()
    {
        ...
        shouldEqual(addAminoAcid(k, symbol, ts), true);
    ...
    void testOverrideUninitializedAminoAcid()
    {
        ...
        shouldEqual(tr_t.get().getSymbol() != AminoAcidImpl(k1).getSymbol(), true);
    }
